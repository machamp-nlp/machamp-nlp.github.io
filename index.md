...
This websites introduces MaChAmp and provides an overview of code and papers that use MaChAmp.	We are proud to annouce that MaChAmp has received an <a>EMNLP 2021 outstanding paper award (demo track)!</a>
</div>
